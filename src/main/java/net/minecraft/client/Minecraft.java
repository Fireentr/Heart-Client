...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(Heart.getMainMenuScreen(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(Heart.getMainMenuScreen());
        }
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Heart 0.2 (Minecraft 1.8.9)");
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = Heart.getMainMenuScreen();
        }
    ...
    private void runGameLoop() throws IOException
    {
        ...
        {
            if (thePlayer != null && Heart.getBus().hasSubscriberForEvent(TickEvent.class)) {
                Heart.getBus().postSticky(new TickEvent(Direction.PRE));
            }
            this.runTick();
            if (thePlayer != null && Heart.getBus().hasSubscriberForEvent(TickEvent.class)) {
                Heart.getBus().postSticky(new TickEvent(Direction.POST));
            }
        }
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        if (thePlayer != null && Heart.getBus().hasSubscriberForEvent(KeyPressEvent.class)) {
                            Heart.getBus().postSticky(new KeyPressEvent(k));
                        }
