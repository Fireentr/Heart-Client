...
public class DropshadowShader extends Shader {
    public DropshadowShader() throws IOException {
        super(new ResourceLocation("heart/shader/Vertex.vert"), new ResourceLocation("heart/shader/DropShadow.frag"));
    }

    public void drawRectWithShader(float x, float y, float width, float height, int outlineWidth, int rounded, Color color, boolean fill){
        ...
        GL20.glUniform1i(GL20.glGetUniformLocation(program, "fill"), fill ? 1 : 0);
